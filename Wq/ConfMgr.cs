...
namespace Wq
{
    ...
    {
        const string IP4_HOME = "192.168.8.18";
        const string IP4_JK = "172.16.10.89";
        ...
        private static ConfMgr _instance = null;
        ...
        private void Init()
        {
            ...
            {
                case IP4_HOME:
                    filePath = "D:/workspace/git-mir/mir2/Wq/Conf.json";
                    break;
                case IP4_JK:
                    filePath = "D:/workspace/git-mir/mir2/Wq/Conf.json";
                    break;
                case IP4_TOSHIBA:
                    filePath = "D:/Projects/mir2suprcode/mir2/Wq/Conf.json";
                    break;
                default:
                    filePath = "";
                    Logger.Log("找不到此IP对应的设备.");
                    break;
            }
            ...
            {
                case IP4_HOME:
                    PathConf = config["Language"]["wangyimin_home"];
                    break;
                case IP4_JK:
                    PathConf = config["Language"]["wangyimin_jk"];
                    break;
                case IP4_TOSHIBA:
                    PathConf = config["Language"]["wangyimin_toshiba"];
                    break;
                default:
                    PathConf = "";
                    Logger.Log("找不到此IP对应的设备.");
